...
[px,py,real_points,img_bw] = find_centroids(pxe,pye,img,celldata,meta); % about 3x faster than find_centroids
% [px,py,real_points] = find_centroids_old(pxe,pye,img,celldata,meta);
