function [cb] = get_cell_boundary2(image_raw,vM)
...
cell_boundaries = get_boundary(image_raw,threshold,min_cell_threshold);
...
fcn2 = @(a,b) set(fig,'UserData',get_boundary(image_raw,sld_threshselector.Value,min_cell_threshold));
...
cell_boundary = get_boundary(image_raw,sld_threshselector.Value,min_cell_threshold);
...
%     I1 = adaptthresh(image,threshold,'Statistic','gaussian');
